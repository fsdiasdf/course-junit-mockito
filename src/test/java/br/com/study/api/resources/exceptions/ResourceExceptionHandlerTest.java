package br.com.study.api.resources.exceptions;
    ...
    void dataIntegrityViolationException() {
        ResponseEntity<StandardError> response = exceptionHandler
                .dataIntegrityViolationException(
                        new DataIntegratyViolationException(O_E_MAIL_JA_FOI_CADASTRADO_NA_NOSSA_BASE_DE_DADOS),
                        new MockHttpServletRequest());
        ...
        assertEquals(ResponseEntity.class, response.getClass());
        assertEquals(StandardError.class, response.getBody().getClass());
        assertEquals(O_E_MAIL_JA_FOI_CADASTRADO_NA_NOSSA_BASE_DE_DADOS, response.getBody().getError());
